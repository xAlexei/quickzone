...
<div id="page">
    ...
    <div class="page-content">
        ...
        <div class="card card-style shadow-xl">
            <div class="content">
                <p class="color-highlight font-600 mb-n1">Con Quickzone®</p>
                <h1 class="font-24 font-700 mb-2">Descubre nuevos servicios  <i class="fa fa-star mt-n2 font-30 color-yellow-dark float-end me-2 scale-box"></i></h1>
                <p class="mb-1">
                    Descubre todos los productos y servicios que esten a tu alcance.
                </p>
            </div>
        </div>
