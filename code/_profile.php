            ...
            <div class="content mb-0">
                <div class="row mb-0 text-center">
                    <div class="col-4">
                        ...
                        <p class="font-10 mb-0 pb-0">Followers</p>
                    </div>
                    <div class="col-4">
                        <h1 class="mb-n1">193</h1>
                        <p class="font-10 mb-0 pb-0">Following</p>
                    </div>
                    <div class="col-4">
                        <h1 class="mb-n1">615</h1>
                        <p class="font-10 mb-0 pb-0">Posts</p>
                    </div>
                </div>
                ...
                <div class="row mb-0 pb-4">
                    <div class="col-6">
                        <a href="#" class="btn btn-m btn-full rounded-s bg-highlight font-13 font-600">Follow</a>
                    </div>
                    <div class="col-6">
                        <a href="#" class="btn btn-m btn-full rounded-s border-highlight color-highlight font-13 font-600">Message</a>
                    </div>
                </div>
                
                <div class="divider mb-4"></div>
                
                <p class="color-highlight font-600 mb-n1 font-12">by Jane Louder</p>
                <h4>Recent Photos</h4>
                ...
                <div class="row text-center row-cols-3 mb-n1">
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/1t.jpg" title="Vynil and Typerwritter">
                        <img data-src="images/pictures/1s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/2t.jpg" title="Cookies">
                        <img data-src="images/pictures/2s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/3t.jpg" title="Cookies and Flowers">
                        <img data-src="images/pictures/3s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/4t.jpg" title="Pots and Pans">
                        <img data-src="images/pictures/4s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/5t.jpg" title="Berries are Packed with Fiber">
                        <img data-src="images/pictures/5s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/6t.jpg" title="A beautiful Retro Camera">
                        <img data-src="images/pictures/6s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/7t.jpg" title="Pots and Pans">
                        <img data-src="images/pictures/7s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/8t.jpg" title="Berries are Packed with Fiber">
                        <img data-src="images/pictures/8s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                    <a class="col mb-4" data-gallery="gallery-1" href="images/pictures/9t.jpg" title="A beautiful Retro Camera">
                        <img data-src="images/pictures/9s.jpg" class="img-fluid rounded-xs preload-img" alt="img">
                    </a>
                </div>
            </div>
        </div>
